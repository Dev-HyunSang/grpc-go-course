...
func (x *DummyService) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DummyService) ProtoMessage() {}

func (x *DummyService) ProtoReflect() protoreflect.Message {
	mi := &file_dummy_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DummyService.ProtoReflect.Descriptor instead.
func (*DummyService) Descriptor() ([]byte, []int) {
...
var file_dummy_proto_rawDesc = []byte{
	...
	0x32, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x65, 0x76, 0x2d,
	0x68, 0x79, 0x75, 0x6e, 0x73, 0x61, 0x6e, 0x67, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x67, 0x6f,
...
var file_dummy_proto_goTypes = []interface{}{
	...
	(*DummyService)(nil), // 1: greet.DummyService
}
